...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
	return <div ref={ref} data-sidebar='header' className={cn('flex flex-col gap-2 pt-4 pb-2 px-4', className)} {...props} />;
});
SidebarHeader.displayName = 'SidebarHeader';

const SidebarFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
	return <div ref={ref} data-sidebar='footer' className={cn('flex flex-col gap-2 pt-2 pb-4 px-4', className)} {...props} />;
});
...
const SidebarMenuSub = React.forwardRef<HTMLUListElement, React.ComponentProps<'ul'>>(({ className, ...props }, ref) => (
	<ul
		...
		className={cn(
			'mx-3.5 flex min-w-0 translate-x-px flex-col gap-2 border-l border-sidebar-border px-2.5 pt-2',
			'group-data-[collapsible=icon]:hidden',
			className
		)}
		{...props}
