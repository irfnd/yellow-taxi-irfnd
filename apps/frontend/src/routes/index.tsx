	...
	return (
		<DashboardLayout>
			<div className='flex flex-col w-full gap-4'>
				...
				<div className='flex flex-col w-full gap-4'>
					<div className='grid auto-rows-min gap-4 grid-cols-1 group-has-[[data-collapsible=icon]]/sidebar-wrapper:lglg:grid-cols-3 group-has-[[data-collapsible=icon]]/sidebar-wrapper:lg:xl:grid-cols-3 md:grid-cols-3'>
